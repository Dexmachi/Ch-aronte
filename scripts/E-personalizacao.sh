#!/bin/bash
read -p -r "ok, me dá um nome pro seu pc aí... e pelo amor de deus, me dá um nome bonito" nome_pc
while [[ -z "$nome_pc" || "$nome_pc" =~ [^a-zA-Z0-9.-] ]]; do
  read -p -r "Nome inválido. Só letras, números, ponto ou hífen. Tenta de novo aí oh jegue: " nome_pc
done
...
sleep 1
read -p -r "Nome teu usuário: " nome_user
