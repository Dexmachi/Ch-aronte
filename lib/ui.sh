...
"Portugues")
  ...
  MSG_PROMPT_BOOT_PART_SIZE="Tamanho da partição BOOT (ex: 1G): "
  ...
  MSG_PROMPT_ROOT_PART_SIZE="Tamanho da partição ROOT (ex: 50G, 100% para usar o resto): "
  ...
  MSG_PROMPT_SWAP_PART_SIZE="Tamanho da partição SWAP (ex: 8G): "
...
"English")
  ...
  MSG_PROMPT_BOOT_PART_SIZE="Partition size for BOOT (e.g., 1G): "
  ...
  MSG_PROMPT_ROOT_PART_SIZE="Partition size for ROOT (e.g., 50G, 100% for the rest of the disk): "
  ...
  MSG_PROMPT_SWAP_PART_SIZE="Partition size for SWAP (e.g., 8G): "
